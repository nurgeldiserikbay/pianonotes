...
import IconCombo from '@/assets/icons-v2/bolt.svg'
import IconHeart from '@/assets/icons-v2/heart.svg'
import IconScore from '@/assets/icons-v2/crown.svg'
import IconTimer from '@/assets/icons-v2/timer.svg'
